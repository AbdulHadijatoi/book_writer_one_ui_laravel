      ...
      <form id="str_chapter_form" class="js-validation" action="{{route('update_str_chapter')}}" method="POST">
                    ...
                    <div class="row items-push">
                      <div class="col-xl-12 m-auto">
                        <div class="items-push mb-4 m-auto col-xl-11 d-flex justify-content-between flex-column flex-lg-row">
                            <div>
                              ...
                              <select class="js-select2 form-select" id="chapter_type_id" name="chapter_type_id" style="width: 100%;" data-placeholder="Chapter Type" required>
                                ...
                                <option value="1" @if(isset($currentChapter) && $currentChapter->chapter_type_id == 1) {{'selected'}} @endif>Normal Chapter</option>
                                <option value="2" @if(isset($currentChapter) && $currentChapter->chapter_type_id == 2) {{'selected'}} @endif>Interlude</option>
                                <option value="3" @if(isset($currentChapter) && $currentChapter->chapter_type_id == 3) {{'selected'}} @endif>Prologue</option>
                                <option value="4" @if(isset($currentChapter) && $currentChapter->chapter_type_id == 4) {{'selected'}} @endif>Epilogue</option>
                              </select>
                            ...
                            <div>
                              ...
                              <input type="number" class="form-control" id="chapter_number" name="chapter_number" placeholder="Chapter number" min="1" value="{{$currentChapter->chapter_number ?? ''}}" required>
                            ...
                            <div>
                              ...
                              <input type="number" class="form-control" id="chapter_position" name="chapter_position" placeholder="Chapter position" min="1" value="{{$currentChapter->chapter_position ?? ''}}" required>
                        ...
                        <div class="form-floating mb-4">
                          <input type="text" class="form-control" id="chapter_title" name="chapter_title" placeholder="Chapter Title" value="{{$currentChapter->chapter_title ?? ''}}">
                        ...
                        <div class="form-floating mb-4">
                          <input type="text" class="form-control" id="chapter_location" name="chapter_location" placeholder="Scene Location"  value="{{$currentChapter->chapter_location ?? ''}}">
                        ...
                        <div class="form-floating mb-4">
                          <textarea class="form-control" id="chapter_characters" name="chapter_characters" style="height: 200px" placeholder="Characters">{{$currentChapter->chapter_characters ?? ''}}</textarea>
                        ...
                        <div class="form-floating mb-4">
                          <textarea class="form-control" id="chapter_abstract" name="chapter_abstract" style="height: 200px" placeholder="Abstract">{{$currentChapter->chapter_abstract ?? ''}}</textarea>
                        ...
                        <div class="form-floating mb-4">
                          <textarea class="form-control" id="chapter_issues" name="chapter_issues" style="height: 200px" placeholder="Enjeux et place dans le recit">{{$currentChapter->chapter_issues ?? ''}}</textarea>
        ...
        @if (isset($scenes))
          ...
          @foreach ($scenes as $scene)
            ...
            <div id="row{{$i}}" class="row count-row">
              <div class="col-md-12">
                <div class="block block-rounded">
                  <div class="block-header block-header-default">
                    <h3 class="block-title">Scene {{$scene->scene_number}}</h3>
                    <div class="block-options">
                      <button type="button" class="btn-block-option" data-toggle="block-option" data-action="fullscreen_toggle"></button>
                      <button type="button" class="btn-block-option" data-toggle="block-option" data-action="content_toggle"></button>
                    </div>
                          ...
                          <div class="col-xl-12 m-auto">
                            <div class="items-push m-auto col-xl-12 d-flex justify-content-center">
                              <div>
                                ...
                                <input type="number" class="form-control" id="scene_number" name="scene_number[]" placeholder="Scene number" min="1" value="{{$scene->scene_number}}" required>
                            ...
                            <div class="form-floating mb-4">
                              <input type="text" class="form-control" id="scene_location" name="scene_location[]" value="{{$scene->scene_location}}" placeholder="Scene Location">
                            ...
                            <div class="form-floating mb-4">
                              <input type="text" class="form-control" id="scene_characters" name="scene_characters[]" value="{{$scene->scene_characters}}" placeholder="Scene Characters">
                            ...
                            <div class="form-floating mb-4">
                              <textarea class="form-control" id="scene_issues" name="scene_issues[]" style="height: 200px" placeholder="Enjeux et place dans le recit">{{$scene->scene_issues}}</textarea>
                            ...
                            <div class="form-floating mb-4">
                              <textarea class="form-control" id="scene_abstract" name="scene_abstract[]" style="height: 200px" placeholder="Abstract">{{$scene->scene_abstract}}</textarea>
                        ...
                        <div class="row items-push">
                          <div class="col-xl-12 m-auto d-flex justify-content-between">
                            <button type="button" id="btn_addScene" class="btn btn-success btn_add_scene" onclick="addScene()">New Scene</button>
                              @if($i >= 2)
                                <button type="button" id="{{$i}}" class="btn btn-warning btn_remove_scene" onclick="removeScene(this)">Delete</button>
                              @endif
                              @php
                                $i++;
                              @endphp
...
<script type="text/javascript">   
    ...
    var i=document.querySelectorAll('.count-row').length;
    // console.log(i);
