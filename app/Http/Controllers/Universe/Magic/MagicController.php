...
class MagicController extends Controller
{
    ...
    public function index()
    {
        ...
        if($book != null){
            ...
            return view('/universe/magic/index',['m_universes'=>$universe]);
        }
    ...
    public function store(Request $request)
    {
        ...
        if($book != null){
            ...
            $request->request->add(['universe_type_id' => 3]);
    ...
    public function show($id)
    {
        ...
        if($book != null){
            ...
            return view('/universe/magic/view',['m_universe'=>$universe, 'm_universes'=>$universes]);
        }
        return back()->with('failed',"You don't have access to that universe.");
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('magic.index')->with('success','successfully deleted!');
    }
}
